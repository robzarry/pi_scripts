...
# pushd FireSight; make clean; popd
# if [ -e FireSight/jannson ]; then pushd FireSight/jannson; make clean; popd; fi
# pushd FireFUSE; make clean; popd
# pushd gfilter; make clean; popd
rm -rf ../python_games
